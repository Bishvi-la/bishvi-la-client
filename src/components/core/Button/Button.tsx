...
import { ActivityIndicator, Animated, StyleSheet, TextStyle, TouchableOpacity, View, ViewStyle } from 'react-native';
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const buttonStyles = [
    ...
    color === 'primary' ? styles.primary : color === 'secondary' ? styles.secondary : styles.tertiary,
    // eslint-disable-next-line no-nested-ternary
  ...
  return (
    <TouchableOpacity onPress={onPress} style={buttonStyles} delayPressIn={delayPressIn} disabled={isLoading}>
